...
} from '@/domains/album/components/detail'
import { FlottingButton, Header } from '@/shared/components'
import Icon from '@/shared/components/Icon'
import { Modal } from '@/shared/components/Modal'
import { AlbumLayout } from '@/shared/ui/skeleton/AlbumLayout'

// hooks
import useCollectionStore from '@/domains/album/stores/collectionStore'
...
// types
import { ClusterInterface } from '@/domains/album/types/album.types'
import { RawPicture } from '@/shared/types'
    ...
    return (
        <>
            ...
            {(duplicatedCollection?.count !== 0 || shakyCollection?.count !== 0) && (
                <div className='m-4 mt-6'>
                    <div className='ml-4 font-sans text-md'>검토가 필요한 사진 </div>
