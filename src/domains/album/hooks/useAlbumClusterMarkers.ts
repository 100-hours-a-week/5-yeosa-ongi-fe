...
} from '@/domains/album/hooks/useKakaoMap' // 타입을 useKakaoMap에서 import
import { useMainPageStore } from '@/domains/album/stores/mainPageStore'
import {
    CLUSTER_CONFIG,
    ...
    type AlbumData,
    type PanToCallback,
} from '@/domains/album/utils/mapMarkerUtils'
